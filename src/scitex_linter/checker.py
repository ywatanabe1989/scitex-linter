...
Soft-migration shim. The canonical home is `scitex_dev.lint.checker`.
External plugins import ``Issue`` and ``_is_allowed_by_comment`` from this
module — kept as named re-exports for back-compat.
"""

from scitex_dev.lint.checker import *  # noqa: F401,F403
from scitex_dev.lint.checker import (  # noqa: F401  back-compat names
    Issue,
    SciTeXChecker,
